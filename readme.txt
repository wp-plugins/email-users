...
A plugin for wordpress which allows you to send an e-mail to your registered blog users, based on their role. Some translations of the plugin to Danish, Italian and Japanese can be found on the [plugin home page](http://email-users.vincentprat.info).
...
= Where to find the translationsfor the plugin? =

Visit the [repository for the locale files](http://email-users-locales.vincentprat.info).
