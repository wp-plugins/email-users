...
Version: 2.1
Plugin URI: http://www.vincentprat.info/wordpress/category/coding/email-users/
...
function mailusers_add_pages() {
	add_submenu_page( 'post.php', __('Send email to users'), __('Send email to users'), 8, 'post.php?page=email_users/email_users_form.php' );
	add_options_page( __('Email users'), __('Email users'), 8, 'options-general.php?page=email_users/email_users_options_form.php' );
}
 ...
 */
add_action('activate_email_users/email_users.php','mailusers_plugin_activation');
