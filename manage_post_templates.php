<div class="wrap">
<h2><?php echo __("Post templates"); ?></h2>
<?php
...
$posts = post_templates_get_post_templates();
	...
	foreach($posts_columns as $column_name=>$column_display_name) {
		...
		case 'author':
			...
			<td><?php 
				...
				echo apply_filters('the_author', $author->display_name); ?>
			</td>
			<?php
			break;

		case 'control_to_post':
			?>
			<td><?php if (post_templates_is_current_user_allowed_to_view()) { 
					$link = "edit.php?page=post-template/new_post_from_template.php&amp;template=$post->ID";
					echo "<a href='$link' class='edit' title='" . __('Create a new post from this template') . "'>" . __('New Post') . "</a>"; 
				} ?></td>
			<?php
			break;
